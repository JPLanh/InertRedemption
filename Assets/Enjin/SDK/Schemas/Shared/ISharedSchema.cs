...
namespace Enjin.SDK.Shared
{
    ...
    public interface ISharedSchema
    {
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinToken>> GetAsset(FindAssetToken request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<List<EnjinToken>>> GetAssets(FindAssetToken request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<List<EnjinBalance>>> GetBalances(GetBalances request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> GetRequest(GetRequest request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<List<EnjinTransaction>>> GetRequests(GetRequests request);
    }
}