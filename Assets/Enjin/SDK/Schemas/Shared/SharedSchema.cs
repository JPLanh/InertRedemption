...
namespace Enjin.SDK.Shared
{
    ...
    public class SharedSchema : BaseSchema, ISharedSchema
    {
        ...
        /// <inheritdoc/>
        public Task<GraphqlResponse<EnjinToken>> GetAsset(FindAssetToken request)
        {
        ...
        /// <inheritdoc/>
        public Task<GraphqlResponse<List<EnjinBalance>>> GetBalances(GetBalances request)
        {
        ...
        /// <inheritdoc/>
        public Task<GraphqlResponse<EnjinTransaction>> GetRequest(GetRequest request)
        {
            return TransactionRequest(request);
        }

        /// <inheritdoc/>
        public Task<GraphqlResponse<List<EnjinTransaction>>> GetRequests(GetRequests request)
        {
        ...
        //}
        protected Task<GraphqlResponse<EnjinTransaction>> TransactionRequest(IGraphqlRequest request)
        {
            return SendRequest(RequestService.GetOne(Schema, CreateRequestBody(request)));
        }
    }
