...
namespace Enjin.SDK.ProjectSchema
{
    ...
    public interface IProjectSchema : ISharedSchema
    {
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> CompleteTrade(CompleteTrade request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> CreateAsset(CreateAsset request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> CreateTrade(CreateTrade request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> DecreaseMaxMeltFee(DecreaseMaxMeltFee request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> DecreaseMaxTransferFee(DecreaseMaxTransferFee request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<List<EnjinUser>>> GetPlayers(GetPlayers request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> MintAsset(MintAsset request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> ReleaseReserve(ReleaseReserve request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> SetMeltFee(SetMeltFee request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> SetTransferable(SetTransferable request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> SetTransferFee(SetTransferFee request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> SetUri(SetUri request);
        ...
        /// <param name="request">The request.</param>
        /// <returns>The task.</returns>
        Task<GraphqlResponse<EnjinTransaction>> SetWhitelisted(SetWhitelisted request);
