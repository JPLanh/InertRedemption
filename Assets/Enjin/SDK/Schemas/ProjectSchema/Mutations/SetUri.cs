...
namespace Enjin.SDK.ProjectSchema
{
    ...
    public class SetUri : GraphqlRequest<SetUri>, IProjectTransactionRequestArguments<SetUri>
    {
        ...
        /// Sole constructor.
        /// </summary>
        public SetUri() : base("enjin.sdk.player.SetUri")
        {
        }
        
        public SetUri IdentityId(int? identityId)
        {
            return SetVariable("identityId", identityId);
        }

        public SetUri Token_id(string? token_id)
        {
        ...
        public SetUri Item_Uri(string? item_uri)
        {
            return SetVariable("item_uri", item_uri);
        }
    }
}